...
async function normalizeCatastrophicSsrResponse(response: Response | undefined | null): Promise<Response> {
  if (!response || typeof response.status !== "number") return brandedErrorResponse();
