    ...
    <span className={`inline-flex items-center gap-2.5 ${className}`}>
      ...
      {!compact && (
        <span className="flex flex-col leading-none">
          <span className="font-display text-base font-semibold tracking-[0.18em]">COAST &amp; PEAK</span>
          <span className="font-serif text-[10px] tracking-[0.42em] text-muted-foreground">STUDIO</span>
        </span>
      )}
    </span>
  );
